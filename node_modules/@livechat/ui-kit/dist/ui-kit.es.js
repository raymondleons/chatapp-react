import styled, { css, injectGlobal, useStylisPlugin } from 'react-emotion';
...
var withSubtheme = (function (WrappedComponent) {
	...
	var WithSubtheme = (_temp = _class = function (_Component) {
		...
		return WithSubtheme;
	}(Component), _class.displayName = 'WithSubtheme(' + getDisplayName(WrappedComponent) + ')', _class.mergeInnerTheme = mergeInnerTheme(WrappedComponent.displayName), _temp);
	return WithSubtheme;
});

var displayName = 'ChatList';

var StyledList = /*#__PURE__*/styled('div', {
	target: 'css-76sfwe0'
})(function (props) {
...
var StyledRow = /*#__PURE__*/styled('div', {
	target: 'css-1lctg0f0'
...
var StyledItem = /*#__PURE__*/styled(Row$1, {
	target: 'css-11i5kng0'
...
var StyledBar = /*#__PURE__*/styled(Row$1, {
	target: 'css-6m0i1h0'
...
var StyledAvatar = /*#__PURE__*/styled('div', {
	target: 'css-1dyjcbv0'
			...
			return React.createElement(
				...
				Children.map(this.props.children, function (child, index) {
					return React.cloneElement(child, {
						namedIndex: getIndexName(index, Children.count(_this2.props.children)),
						childIndex: index
					});
				})
			);
...
var StyledBubble = /*#__PURE__*/styled('div', {
	target: 'css-x3tyo90'
...
var StyledColumn = /*#__PURE__*/styled('div', {
	target: 'css-1jgqyg00'
...
var StyledFill = /*#__PURE__*/styled('div', {
	target: 'css-1aew2uu0'
...
var Fill$1 = function Fill(props) {
	return React.createElement(StyledFill, props);
};
...
var StyledFit = /*#__PURE__*/styled('div', {
	target: 'css-15igdy50'
...
var Fit$1 = function Fit(props) {
	return React.createElement(StyledFit, props);
};
...
var withThemeDescription = (function (WrappedComponent) {
	...
	return withTheme((_temp = _class = function (_Component) {
		...
		WithThemeDescription.prototype.render = function render() {
			...
			return React.createElement(WrappedComponent, _extends({}, props, componentTheme));
		};

		return WithThemeDescription;
	}(Component), _class.displayName = 'WithThemeDescription(' + getDisplayName(WrappedComponent) + ')', _temp));
});
...
var IconButton$1 = function IconButton(_ref) {
	...
	return React.createElement(
		StyledButton,
		props,
		active ? cloneElement(children, { color: activeColor }) : children
	);
};
...
var StyledList$1 = /*#__PURE__*/styled('div', {
	target: 'css-1qc944d0'
...
var StyledMessage = /*#__PURE__*/styled('div', {
	target: 'css-plmfxb0'
...
var AuthorName = /*#__PURE__*/styled('span', {
	target: 'css-plmfxb1'
...
var MessageMeta = /*#__PURE__*/styled('div', {
	target: 'css-plmfxb3'
})(function (props) {
...
var Status = /*#__PURE__*/styled('div', {
	target: 'css-plmfxb6'
	...
	Message.prototype.render = function render() {
		...
		var message = React.createElement(
			...
			React.createElement(
				AvatarWrapper,
				{ isOwn: isOwn },
				avatarUrl && React.createElement(Avatar$1, { imgUrl: avatarUrl, isOwn: isOwn })
			),
			React.createElement(
				Content,
				null,
...
var Subtitle = /*#__PURE__*/styled('div', {
	target: 'css-1us9r480'
...
var StyledMedia = /*#__PURE__*/styled('div', {
	target: 'css-vuhjaw0'
...
var StyledButtons = /*#__PURE__*/styled('div', {
	target: 'css-11kvs9z0'
...
var StyledButton$1 = /*#__PURE__*/styled('button', {
	target: 'css-k6dg3t0'
...
var StyledGroup = /*#__PURE__*/styled('div', {
	target: 'css-1qtnnow0'
...
var StyledBar$1 = /*#__PURE__*/styled('div', {
	target: 'css-b8inki0'
...
var Title$1 = /*#__PURE__*/styled('div', {
	target: 'css-b8inki1'
...
var StyledComposer = /*#__PURE__*/styled('div', {
	target: 'css-vsx1f0'
...
var withComposer = (function () {
	...
	return function (WrappedComponent) {
		...
		return _temp2 = _class = function (_Component) {
			...
			return WithComposer;
		}(Component), _class.displayName = 'withComposer(' + getDisplayName(WrappedComponent) + ')', _temp2;
	};
});
	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				"g",
				{ fill: "#000000", id: "send" },
				React.createElement("polygon", { id: "Shape", points: "0.01 18 21 9 0.01 0 0 7 15 9 0 11" })
			)
		)
	);
});
...
var StyledInput = /*#__PURE__*/styled(TextareaAutosize, {
	target: 'css-19r18zv0'
...
var TextInput = function (_Component) {
	...
	TextInput.prototype.render = function render() {
		...
		return React.createElement(StyledInput, _extends({}, props, { inputRef: innerRef }));
	};
...
var StyledWrapper$1 = /*#__PURE__*/styled('div', {
	target: 'css-1vvtvjt0'
...
var StyledWrapper$2 = /*#__PURE__*/styled('div', {
	target: 'css-15wh53n0'
...
var RateGoodIcon = function RateGoodIcon(props) {
	return React.createElement(
		Icon,
		props,
		React.createElement(Close$2, null)
	);
};

useStylisPlugin(varsPlugin);

export { FixedWrapper, ChatList$1 as ChatList, ChatListItem$1 as ChatListItem, AgentBar$1 as AgentBar, Avatar$1 as Avatar, Bubble$2 as Bubble, Column$1 as Column, Fill$1 as Fill, Fit$1 as Fit, IconButton$2 as IconButton, Message$2 as Message, MessageTitle, MessageText, MessageMedia, MessageButtons, MessageButton, MessageGroup$1 as MessageGroup, MessageList$2 as MessageList, MessageListItem$1 as MessageListItem, Row$1 as Row, ThemeProvider$2 as ThemeProvider, Subtitle, Title, TitleBar$2 as TitleBar, Toggle$1 as Toggle, SendButton$1 as SendButton, TextComposer$1 as TextComposer, TextInput$1 as TextInput, TEXT_COMPOSER, Icon, AddIcon, CloseIcon, EmojiIcon, MenuVerticalIcon, SendIcon, ChatIcon, RateBadIcon, RateGoodIcon, defaultTheme, darkTheme, purpleTheme, elegantTheme };
