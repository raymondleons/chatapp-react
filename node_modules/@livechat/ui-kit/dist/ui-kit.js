  ...
  switch (typeof interpolation) {
    ...
    case 'function':
      if (interpolation[STYLES_KEY] !== undefined) {
        if ("development" !== 'production' && interpolation[TARGET_KEY] === undefined) {
...
function createStyles(strings) {
  ...
  hash$1 = hashString(styles + identifierName);
  name = hash$1 + identifierName;
  return styles;
}
...
function css() {
  ...
  if (inserted[hash$1] === undefined) {
    stylis("." + selector, styles);
    inserted[hash$1] = true;
  }
...
var parseCommonProps = function parseCommonProps(props) {
	...
	if (props.fit) {
		if ("development" === 'development' && props.fill) {
...
var createEagerElementUtil = function createEagerElementUtil(hasKey, isReferentiallyTransparent, type, props, children) {
  ...
  if (children) {
    return React__default.createElement(Component$$1, props, children);
  }
...
var hoistNonReactStatics$2 = function hoistNonReactStatics(targetComponent, sourceComponent, blacklist) {
...
var isPlainObject$2 = function isPlainObject(test) {
...
var withTheme = function withTheme(Component$$1) {
  ...
  function _render() {
    return React.createElement(Component$$1, _extends$2({
  ...
  return hoistNonReactStatics$2(WithTheme, Component$$1);
};
...
var mergeInnerTheme = function mergeInnerTheme(componentName) {
	return function (theme) {
		...
		return merge$2(theme, pickComponentKeys(componentDescription));
	};
};
...
var withSubtheme = (function (WrappedComponent) {
	...
	var WithSubtheme = (_temp = _class = function (_Component) {
		...
		return WithSubtheme;
	}(React.Component), _class.displayName = 'WithSubtheme(' + getDisplayName(WrappedComponent) + ')', _class.mergeInnerTheme = mergeInnerTheme(WrappedComponent.displayName), _temp);
	return WithSubtheme;
});

var displayName = 'ChatList';

var StyledList = /*#__PURE__*/createStyled('div', {
	target: 'css-76sfwe0'
})(function (props) {
...
var StyledRow = /*#__PURE__*/createStyled('div', {
	target: 'css-1lctg0f0'
...
var StyledItem = /*#__PURE__*/createStyled(Row$1, {
	target: 'css-11i5kng0'
...
var StyledBar = /*#__PURE__*/createStyled(Row$1, {
	target: 'css-6m0i1h0'
...
var StyledAvatar = /*#__PURE__*/createStyled('div', {
	target: 'css-1dyjcbv0'
...
var propsParser$3 = function propsParser(props) {
	...
	var themeStyles = isOwn ? merge$2(Bubble.css, OwnBubble.css) : Bubble.css;
...
var StyledBubble = /*#__PURE__*/createStyled('div', {
	target: 'css-x3tyo90'
...
var StyledColumn = /*#__PURE__*/createStyled('div', {
	target: 'css-1jgqyg00'
...
var StyledFill = /*#__PURE__*/createStyled('div', {
	target: 'css-1aew2uu0'
...
var StyledFit = /*#__PURE__*/createStyled('div', {
	target: 'css-15igdy50'
...
var withThemeDescription = (function (WrappedComponent) {
	...
	return withTheme((_temp = _class = function (_Component) {
	...
	}(React.Component), _class.displayName = 'WithThemeDescription(' + getDisplayName(WrappedComponent) + ')', _temp));
});

var displayName$5 = 'IconButton';

var StyledButton = /*#__PURE__*/createStyled('button', {
	target: 'css-1aid8ih0'
...
var StyledList$1 = /*#__PURE__*/createStyled('div', {
	target: 'css-1qc944d0'
...
var isReferentiallyTransparentFunctionComponent = function isReferentiallyTransparentFunctionComponent(Component$$1) {
  return Boolean(typeof Component$$1 === 'function' && !(0, _isClassComponent2.default)(Component$$1) && !Component$$1.defaultProps && !Component$$1.contextTypes && ("development" === 'production' || !Component$$1.propTypes));
};
...
var withState$1 = unwrapExports(withState_1);
...
var withToggle = (function (spec) {
	...
	var withOpen = withState$1(config.opened, 'setOpened', false);
	...
	return compose$1(withOpen, withToggle);
});
...
var calculatedTheme = function calculatedTheme(isOwn, theme) {
	...
	return isOwn ? merge$2(Message, OwnMessage) : Message;
};
...
var StyledMessage = /*#__PURE__*/createStyled('div', {
	target: 'css-plmfxb0'
...
var AuthorName = /*#__PURE__*/createStyled('span', {
	target: 'css-plmfxb1'
...
var AvatarWrapper = /*#__PURE__*/createStyled('div', {
	target: 'css-plmfxb2'
...
var MessageMeta = /*#__PURE__*/createStyled('div', {
	target: 'css-plmfxb3'
})(function (props) {
	return { textAlign: props.isOwn ? 'right' : 'left' };
}, ';');

var Content = /*#__PURE__*/createStyled('div', {
	target: 'css-plmfxb4'
})('display:flex;flex-direction:column;overflow:hidden;');

var Time = /*#__PURE__*/createStyled('span', {
	target: 'css-plmfxb5'
...
var Status = /*#__PURE__*/createStyled('div', {
	target: 'css-plmfxb6'
...
var Subtitle = /*#__PURE__*/createStyled('div', {
	target: 'css-1us9r480'
...
var Title = /*#__PURE__*/createStyled('div', {
	target: 'css-1y96l3i0'
...
var StyledTitle = /*#__PURE__*/createStyled('div', {
	target: 'css-g2ftaa0'
...
var StyledText = /*#__PURE__*/createStyled('div', {
	target: 'css-g63hhb0'
...
var StyledMedia = /*#__PURE__*/createStyled('div', {
	target: 'css-vuhjaw0'
...
var StyledButtons = /*#__PURE__*/createStyled('div', {
	target: 'css-11kvs9z0'
...
function rgb(value, green, blue) {
  ...
  } else if ((typeof value === 'undefined' ? 'undefined' : _typeof$2(value)) === 'object' && green === undefined && blue === undefined) {
...
function rgba(firstValue, secondValue, thirdValue, fourthValue) {
  ...
  } else if ((typeof firstValue === 'undefined' ? 'undefined' : _typeof$2(firstValue)) === 'object' && secondValue === undefined && thirdValue === undefined && fourthValue === undefined) {
...
function hsla(value, saturation, lightness, alpha) {
  ...
  } else if ((typeof value === 'undefined' ? 'undefined' : _typeof$2(value)) === 'object' && saturation === undefined && lightness === undefined && alpha === undefined) {
...
function toColorString(color) {
  if ((typeof color === 'undefined' ? 'undefined' : _typeof$2(color)) !== 'object') throw new Error(errMsg);
...
var StyledButton$1 = /*#__PURE__*/createStyled('button', {
	target: 'css-k6dg3t0'
...
var buttonClass = /*#__PURE__*/css('display:inline-block;width:100%;border-left:0;border-right:0;border-top:0;border-bottom-color:rgba(0,0,0,0.1);box-shadow:none;transition:background-color 0.1s;background:transparent;color:inherit;&:hover{border-bottom-color:rgba(0,0,0,0.15);background:rgba(0,0,0,0.02);color:inherit;}&:active{background:rgba(0,0,0,0.04);color:inherit;}');
...
var StyledGroup = /*#__PURE__*/createStyled('div', {
	target: 'css-1qtnnow0'
...
var ThemeProvider$2 = mapProps(function (props) {
	return _extends({}, props, {
		theme: parseTheme(merge$2(defaultTheme, props.theme || {}))
	});
})(ThemeProvider);

var displayName$16 = 'TitleBar';

var StyledBar$1 = /*#__PURE__*/createStyled('div', {
	target: 'css-b8inki0'
...
var Title$1 = /*#__PURE__*/createStyled('div', {
	target: 'css-b8inki1'
...
function createBroadcast$1(initialState) {
  var listeners = [];
...
var Broadcast = function (_React$Component) {
  inherits$2(Broadcast, _React$Component);

  function Broadcast() {
    var _temp, _this, _ret;

    classCallCheck$2(this, Broadcast);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn$2(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.broadcast = createBroadcast$1(_this.props.value), _temp), possibleConstructorReturn$2(_this, _ret);
  }
...
var Subscriber = function (_React$Component) {
  inherits$2(Subscriber, _React$Component);

  function Subscriber() {
    var _temp, _this, _ret;

    classCallCheck$2(this, Subscriber);
...
var StyledComposer = /*#__PURE__*/createStyled('div', {
	target: 'css-vsx1f0'
...
var withComposer = (function () {
	...
	return function (WrappedComponent) {
		...
		return _temp2 = _class = function (_Component) {
			...
			return WithComposer;
		}(React.Component), _class.displayName = 'withComposer(' + getDisplayName(WrappedComponent) + ')', _temp2;
	};
});
...
var memoize$3 = function memoize(func) {
	var keys = [];
	var values = [];
	return function () {
...
var createStyledIcon = memoize$3(function (Icon) {
	return (/*#__PURE__*/createStyled(Icon, {
			target: 'css-10wcwhb0'
 ...
 * // => { 'a': 1, 'c': 3 }
 */
var pick$3 = _flatRest(function (object, paths) {
...
var hasControlledProps = compose$1(gt(0), get$2('length'), reject(eq$1(undefined)), values, pick$1);
...
var SendButton$1 = withComposer(function (_ref, ownProps) {
...

	{
		...
		if (hasControlledProps(sendButtonProps, ownProps)) {
			// eslint-disable-next-line no-console
			warnOnce([sendButtonProps + ' props are controlled by TextComposer,', 'if you want to use those please pass them to the TextComposer instead of ' + getDisplayName(SendButton) + '.'].join(' '));
		}
	}
 ...
 * <TextareaAutosize />
 */
var noop$7 = function noop() {}; // IE11 has a problem with eval source maps, can be reproduced with:
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    props.style = _extends$5({}, props.style, {
    ...
    return React__default.createElement("textarea", _extends$5({}, props, {
...
var StyledInput = /*#__PURE__*/createStyled(TextareaAutosize, {
	target: 'css-19r18zv0'
...
var hasControlledProps$1 = compose$1(gt(0), get$2('length'), reject(eq$1(undefined)), values, pick$1);
...
var TextInput$1 = withComposer(function (_ref, ownProps) {
...

	{
		...
		if (hasControlledProps$1(textInputProps, ownProps)) {
			// eslint-disable-next-line no-console
			warnOnce$1([textInputProps + ' props are controlled by TextComposer,', 'if you want to use those please pass them to the TextComposer instead of ' + getDisplayName(TextInput) + '.'].join(' '));
		}
	}
...
var StyledWrapper = /*#__PURE__*/createStyled('div', {
	target: 'css-mzl99t0'
...
var StyledWrapper$1 = /*#__PURE__*/createStyled('div', {
	target: 'css-1vvtvjt0'
...
var StyledWrapper$2 = /*#__PURE__*/createStyled('div', {
	target: 'css-15wh53n0'
...
useStylisPlugin(stylisCustomProperties);
